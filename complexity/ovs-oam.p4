...
//    set_metadata(flow.dl_type, l2_ethertype.eth_type);
    ...
    return select (l2_ethertype.eth_type) {
        0x8847: l2_5_mpls0;
        0x8848: l2_5_mpls0;
        0x8888: l2_oam; // Some L2 OAM implementation
        0x0800: l3_ipv4;
        //0x86dd: l3_ipv6;
        0x0806: l3_arp;
        0x8035: l3_arp;
...
header_type l2_oam_t { fields { oam_flag : 4 } }
header l2_oam_t l2_oam;
parser l2_oam { extract(l2_oam); // set_metadata(flow.tun_oam_flag, latest.oam_flag);
  return ingress; }
